...
return wizard.AbstractWizardView.extend({
	...
	parseWizardOptions() {
		...
		uci.set('wireless', morseInterfaceName, 'ifname', 'wlan0');
		uci.set('wireless', morseInterfaceName, 'encryption', 'sae');
		if (!uci.get('network', 'wlan0')) {
			uci.add('network', 'device', 'wlan0');
		}
		uci.set('network', 'wlan0', 'name', 'wlan0');
		uci.set('network', 'wlan0', 'mtu', '1532');
